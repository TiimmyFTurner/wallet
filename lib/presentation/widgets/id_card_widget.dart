...
class IDCardWidget extends ConsumerStatefulWidget {
  final IDCard idCard;

  const IDCardWidget(this.idCard, {super.key});

  @override
  ConsumerState<IDCardWidget> createState() => _IDCardWidgetState();
}

class _IDCardWidgetState extends ConsumerState<IDCardWidget> {
  bool _lock = false;
                ...
                child: ExpansionTile(
                  ...
                  title: Row(
                    ...
                    children: [
                      ...
                      IconButton(
                          onPressed: () {
                            context.push('/editIDCard/${idCard.id}');
                          },
